...
_PREDEFINED_SPLITS_TEXT = {
    ...
    "ctw1500_word_train": ("CTW1500/ctwtrain_text_image", "CTW1500/annotations/add_seg_train_ctw1500_maxlen100_v2.json"),
    "ctw1500_word_test": ("CTW1500/ctwtest_text_image","CTW1500/annotations/test_ctw1500_maxlen100.json"),
    "syntext1_train": ("syntext1/images", "syntext1/annotations/train_add_seg.json"),
    "syntext2_train": ("syntext2/images", "syntext2/annotations/train_add_seg.json"),
    "mltbezier_word_train": ("mlt2017/images","mlt2017/annotations/train_add_seg.json"),
