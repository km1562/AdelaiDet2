...
Naming convention:
    ...
    ori_annotation_file_list: refers to the ground-truth class of an position.
...
class MEInstOutputs(object):
    ...
    def _get_ground_truth(self):
        ...
        labels_level_first = training_targets["ori_annotation_file_list"]
    ...
    def compute_targets_for_locations(self, locations, targets, size_ranges):
        ...
        return {"ori_annotation_file_list": labels, "reg_targets": reg_targets,
    ...
    def MEInst_losses(
        ...
        if self.loss_on_mask:
            ...
            # m*m mask ori_annotation_file_list --> n_components encoding ori_annotation_file_list
    ...
    def losses(self):
        ...
        labels, reg_targets, mask_targets = training_targets["ori_annotation_file_list"], training_targets["reg_targets"], \
                                            training_targets["mask_targets"]

        # Collect all logits and regression predictions over feature maps
        # and images to arrive at the same shape as the ori_annotation_file_list and targets
