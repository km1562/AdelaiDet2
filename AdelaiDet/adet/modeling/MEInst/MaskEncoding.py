...
class PCAMaskEncoding(nn.Module):
    ...
    To do the mask encoding of PCA.
        ...
        making datas respect some hard-wired assumptions.
    ...
    def encoder(self, X):
        ...
        X : Original features(tensor), shape (n_samples, n_features)
            New datas, where n_samples is the number of samples
    ...
    def decoder(self, X, is_train=False):
        """Transform datas back to its original space.
        ...
        """
        assert X.shape[1] == self.dim_mask, print("The dim of transformed datas "
