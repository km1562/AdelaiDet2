...
from .compute_poly_iou import bezier_para_to_poly
...
def fcos_losses(
    ...
    bezier_loss = ((bezier_loss.flatten(start_dim=1).mean(dim=-1) * ctrness_targets).sum()
                    / loss_denorm)
...
class BATextOutputs(object):
    ...
    def compute_targets_for_locations(self, locations, targets, size_ranges):
        ...
        return {
            "ori_annotation_file_list": labels,
    ...
    def losses(self):
        ...
        labels, reg_targets, bezier_targets = (
            training_targets["ori_annotation_file_list"],
