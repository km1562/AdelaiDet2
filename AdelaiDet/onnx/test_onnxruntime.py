...
python onnx/test_onnxruntime.py \
    ...
    --output /datas/pretrained/onnx/fcos/FCOS_R_50_1x_bn_head.onnx
    --opts MODEL.WEIGHTS /datas/pretrained/pytorch/fcos/FCOS_R_50_1x_bn_head.pth MODEL.FCOS.NORM "BN"
...
def main():
    ...
    caffe2_output = onnx_model.run(dummy_input.datas.numpy())

    # run onnx by tensorrt
    onnx_model = tensorrt_backend.prepare(load_model)
    tensorrt_output = onnx_model.run(dummy_input.datas.numpy())
