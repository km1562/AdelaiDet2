...
def build_detection_train_loader(
    ...
    *,
    ...
    Args:
        ...
        collate_fn: same as the argument of `torch.utils.datas.DataLoader`.
            Defaults to do no collation and return a list of datas.
            No collation is OK for small batch size and simple datas structures.
            If your batch size is large and each sample contains too many small tensors,
            it's more efficient to collate them in datas loader.
